...
!(function (t, e) { typeof exports === 'object' && typeof module !== 'undefined' ? e(exports, require('jquery'), require('popper.js')) : typeof define === 'function' && define.amd ? define(['exports', 'jquery', 'popper.js'], e) : e((t = typeof globalThis !== 'undefined' ? globalThis : t || self).bootstrap = {}, t.jQuery, t.Popper); }(this, ((t, e, n) => {
  ...
  }; const E = { TOUCH: 'touch', PEN: 'pen' }; const w = (function () {
    function t(t, e) { this._items = null, this._interval = null, this._activeElement = null, this._isPaused = !1, this._isSliding = !1, this.touchTimeout = null, this.touchStartX = 0, this.touchDeltaX = 0, this._config = this._getConfig(e), this._element = t, this._indicatorsElement = this._element.querySelector('.carousel-indicators'), this._touchSupported = 'ontouchstart' in document.documentElement || navigator.maxTouchPoints > 0, this._pointerEvent = Boolean(window.PointerEvent || window.MSPointerEvent), this._addEventListeners(); } const e = t.prototype; return e.next = function () { this._isSliding || this._slide('next'); }, e.nextWhenVisible = function () { const t = o.default(this._element); !document.hidden && t.is(':visible') && t.css('visibility') !== 'hidden' && this.next(); }, e.prev = function () { this._isSliding || this._slide('prev'); }, e.pause = function (t) { t || (this._isPaused = !0), this._element.querySelector('.carousel-item-next, .carousel-item-prev') && (d.triggerTransitionEnd(this._element), this.cycle(!0)), clearInterval(this._interval), this._interval = null; }, e.cycle = function (t) { t || (this._isPaused = !1), this._interval && (clearInterval(this._interval), this._interval = null), this._config.interval && !this._isPaused && (this._updateInterval(), this._interval = setInterval((document.visibilityState ? this.nextWhenVisible : this.next).bind(this), this._config.interval)); }, e.to = function (t) { const e = this; this._activeElement = this._element.querySelector('.active.carousel-item'); const n = this._getItemIndex(this._activeElement); if (!(t > this._items.length - 1 || t < 0)) if (this._isSliding)o.default(this._element).one('slid.bs.carousel', (() => e.to(t))); else { if (n === t) return this.pause(), void this.cycle(); const i = t > n ? 'next' : 'prev'; this._slide(i, this._items[t]); } }, e.dispose = function () { o.default(this._element).off(_), o.default.removeData(this._element, 'bs.carousel'), this._items = null, this._config = null, this._element = null, this._interval = null, this._isPaused = null, this._isSliding = null, this._activeElement = null, this._indicatorsElement = null; }, e._getConfig = function (t) { return t = { ...b, ...t }, d.typeCheckConfig(p, t, y), t; }, e._handleSwipe = function () { const t = Math.abs(this.touchDeltaX); if (!(t <= 40)) { const e = t / this.touchDeltaX; this.touchDeltaX = 0, e > 0 && this.prev(), e < 0 && this.next(); } }, e._addEventListeners = function () { const t = this; this._config.keyboard && o.default(this._element).on('keydown.bs.carousel', ((e) => t._keydown(e))), this._config.pause === 'hover' && o.default(this._element).on('mouseenter.bs.carousel', ((e) => t.pause(e))).on('mouseleave.bs.carousel', ((e) => t.cycle(e))), this._config.touch && this._addTouchEventListeners(); }, e._addTouchEventListeners = function () { const t = this; if (this._touchSupported) { const e = function (e) { t._pointerEvent && E[e.originalEvent.pointerType.toUpperCase()] ? t.touchStartX = e.originalEvent.clientX : t._pointerEvent || (t.touchStartX = e.originalEvent.touches[0].clientX); }; const n = function (e) { t._pointerEvent && E[e.originalEvent.pointerType.toUpperCase()] && (t.touchDeltaX = e.originalEvent.clientX - t.touchStartX), t._handleSwipe(), t._config.pause === 'hover' && (t.pause(), t.touchTimeout && clearTimeout(t.touchTimeout), t.touchTimeout = setTimeout(((e) => t.cycle(e)), 500 + t._config.interval)); }; o.default(this._element.querySelectorAll('.carousel-item img')).on('dragstart.bs.carousel', ((t) => t.preventDefault())), this._pointerEvent ? (o.default(this._element).on('pointerdown.bs.carousel', ((t) => e(t))), o.default(this._element).on('pointerup.bs.carousel', ((t) => n(t))), this._element.classList.add('pointer-event')) : (o.default(this._element).on('touchstart.bs.carousel', ((t) => e(t))), o.default(this._element).on('touchmove.bs.carousel', ((e) => (function (e) { e.originalEvent.touches && e.originalEvent.touches.length > 1 ? t.touchDeltaX = 0 : t.touchDeltaX = e.originalEvent.touches[0].clientX - t.touchStartX; }(e)))), o.default(this._element).on('touchend.bs.carousel', ((t) => n(t)))); } }, e._keydown = function (t) { if (!/input|textarea/i.test(t.target.tagName)) switch (t.which) { case 37: t.preventDefault(), this.prev(); break; case 39: t.preventDefault(), this.next(); } }, e._getItemIndex = function (t) { return this._items = t && t.parentNode ? [].slice.call(t.parentNode.querySelectorAll('.carousel-item')) : [], this._items.indexOf(t); }, e._getItemByDirection = function (t, e) { const n = t === 'next'; const i = t === 'prev'; const o = this._getItemIndex(e); const a = this._items.length - 1; if ((i && o === 0 || n && o === a) && !this._config.wrap) return e; const s = (o + (t === 'prev' ? -1 : 1)) % this._items.length; return s === -1 ? this._items[this._items.length - 1] : this._items[s]; }, e._triggerSlideEvent = function (t, e) {
      const n = this._getItemIndex(t); const i = this._getItemIndex(this._element.querySelector('.active.carousel-item')); const a = o.default.Event('slide.bs.carousel', {
        relatedTarget: t, direction: e, from: i, to: n,
      }); return o.default(this._element).trigger(a), a;
    }, e._setActiveIndicatorElement = function (t) { if (this._indicatorsElement) { const e = [].slice.call(this._indicatorsElement.querySelectorAll('.active')); o.default(e).removeClass('active'); const n = this._indicatorsElement.children[this._getItemIndex(t)]; n && o.default(n).addClass('active'); } }, e._updateInterval = function () { const t = this._activeElement || this._element.querySelector('.active.carousel-item'); if (t) { const e = parseInt(t.getAttribute('data-interval'), 10); e ? (this._config.defaultInterval = this._config.defaultInterval || this._config.interval, this._config.interval = e) : this._config.interval = this._config.defaultInterval || this._config.interval; } }, e._slide = function (t, e) {
      let n; let i; let a; const s = this; const l = this._element.querySelector('.active.carousel-item'); const r = this._getItemIndex(l); const u = e || l && this._getItemByDirection(t, l); const f = this._getItemIndex(u); const c = Boolean(this._interval); if (t === 'next' ? (n = 'carousel-item-left', i = 'carousel-item-next', a = 'left') : (n = 'carousel-item-right', i = 'carousel-item-prev', a = 'right'), u && o.default(u).hasClass('active')) this._isSliding = !1; else if (!this._triggerSlideEvent(u, a).isDefaultPrevented() && l && u) {
        this._isSliding = !0, c && this.pause(), this._setActiveIndicatorElement(u), this._activeElement = u; const h = o.default.Event('slid.bs.carousel', {
          relatedTarget: u, direction: a, from: r, to: f,
        }); if (o.default(this._element).hasClass('slide')) { o.default(u).addClass(i), d.reflow(u), o.default(l).addClass(n), o.default(u).addClass(n); const g = d.getTransitionDurationFromElement(l); o.default(l).one(d.TRANSITION_END, (() => { o.default(u).removeClass(`${n} ${i}`).addClass('active'), o.default(l).removeClass(`active ${i} ${n}`), s._isSliding = !1, setTimeout((() => o.default(s._element).trigger(h)), 0); })).emulateTransitionEnd(g); } else o.default(l).removeClass('active'), o.default(u).addClass('active'), this._isSliding = !1, o.default(this._element).trigger(h); c && this.cycle();
      }
    }, t._jQueryInterface = function (e) { return this.each((function () { let n = o.default(this).data('bs.carousel'); let i = { ...b, ...o.default(this).data() }; typeof e === 'object' && (i = { ...i, ...e }); const a = typeof e === 'string' ? e : i.slide; if (n || (n = new t(this, i), o.default(this).data('bs.carousel', n)), typeof e === 'number')n.to(e); else if (typeof a === 'string') { if (typeof n[a] === 'undefined') throw new TypeError(`No method named "${a}"`); n[a](); } else i.interval && i.ride && (n.pause(), n.cycle()); })); }, t._dataApiClickHandler = function (e) { const n = d.getSelectorFromElement(this); if (n) { const i = o.default(n)[0]; if (i && o.default(i).hasClass('carousel')) { const a = { ...o.default(i).data(), ...o.default(this).data() }; const s = this.getAttribute('data-slide-to'); s && (a.interval = !1), t._jQueryInterface.call(o.default(i), a), s && o.default(i).data('bs.carousel').to(s), e.preventDefault(); } } }, l(t, null, [{ key: 'VERSION', get() { return '4.6.0'; } }, { key: 'Default', get() { return b; } }]), t;
  }()); o.default(document).on('click.bs.carousel.data-api', '[data-slide], [data-slide-to]', w._dataApiClickHandler), o.default(window).on('load.bs.carousel.data-api', (() => { for (let t = [].slice.call(document.querySelectorAll('[data-ride="carousel"]')), e = 0, n = t.length; e < n; e++) { const i = o.default(t[e]); w._jQueryInterface.call(i, i.data()); } })), o.default.fn[p] = w._jQueryInterface, o.default.fn[p].Constructor = w, o.default.fn[p].noConflict = function () { return o.default.fn[p] = v, w._jQueryInterface; }; const T = 'collapse'; const C = o.default.fn[T]; const S = { toggle: !0, parent: '' }; const N = { toggle: 'boolean', parent: '(string|element)' }; const D = (function () { function t(t, e) { this._isTransitioning = !1, this._element = t, this._config = this._getConfig(e), this._triggerArray = [].slice.call(document.querySelectorAll(`[data-toggle="collapse"][href="#${t.id}"],[data-toggle="collapse"][data-target="#${t.id}"]`)); for (let n = [].slice.call(document.querySelectorAll('[data-toggle="collapse"]')), i = 0, o = n.length; i < o; i++) { const a = n[i]; const s = d.getSelectorFromElement(a); const l = [].slice.call(document.querySelectorAll(s)).filter(((e) => e === t)); s !== null && l.length > 0 && (this._selector = s, this._triggerArray.push(a)); } this._parent = this._config.parent ? this._getParent() : null, this._config.parent || this._addAriaAndCollapsedClass(this._element, this._triggerArray), this._config.toggle && this.toggle(); } const e = t.prototype; return e.toggle = function () { o.default(this._element).hasClass('show') ? this.hide() : this.show(); }, e.show = function () { let e; let n; const i = this; if (!this._isTransitioning && !o.default(this._element).hasClass('show') && (this._parent && (e = [].slice.call(this._parent.querySelectorAll('.show, .collapsing')).filter(((t) => (typeof i._config.parent === 'string' ? t.getAttribute('data-parent') === i._config.parent : t.classList.contains('collapse'))))).length === 0 && (e = null), !(e && (n = o.default(e).not(this._selector).data('bs.collapse')) && n._isTransitioning))) { const a = o.default.Event('show.bs.collapse'); if (o.default(this._element).trigger(a), !a.isDefaultPrevented()) { e && (t._jQueryInterface.call(o.default(e).not(this._selector), 'hide'), n || o.default(e).data('bs.collapse', null)); const s = this._getDimension(); o.default(this._element).removeClass('collapse').addClass('collapsing'), this._element.style[s] = 0, this._triggerArray.length && o.default(this._triggerArray).removeClass('collapsed').attr('aria-expanded', !0), this.setTransitioning(!0); const l = `scroll${s[0].toUpperCase() + s.slice(1)}`; const r = d.getTransitionDurationFromElement(this._element); o.default(this._element).one(d.TRANSITION_END, (() => { o.default(i._element).removeClass('collapsing').addClass('collapse show'), i._element.style[s] = '', i.setTransitioning(!1), o.default(i._element).trigger('shown.bs.collapse'); })).emulateTransitionEnd(r), this._element.style[s] = `${this._element[l]}px`; } } }, e.hide = function () { const t = this; if (!this._isTransitioning && o.default(this._element).hasClass('show')) { const e = o.default.Event('hide.bs.collapse'); if (o.default(this._element).trigger(e), !e.isDefaultPrevented()) { const n = this._getDimension(); this._element.style[n] = `${this._element.getBoundingClientRect()[n]}px`, d.reflow(this._element), o.default(this._element).addClass('collapsing').removeClass('collapse show'); const i = this._triggerArray.length; if (i > 0) for (let a = 0; a < i; a++) { const s = this._triggerArray[a]; const l = d.getSelectorFromElement(s); if (l !== null)o.default([].slice.call(document.querySelectorAll(l))).hasClass('show') || o.default(s).addClass('collapsed').attr('aria-expanded', !1); } this.setTransitioning(!0); this._element.style[n] = ''; const r = d.getTransitionDurationFromElement(this._element); o.default(this._element).one(d.TRANSITION_END, (() => { t.setTransitioning(!1), o.default(t._element).removeClass('collapsing').addClass('collapse').trigger('hidden.bs.collapse'); })).emulateTransitionEnd(r); } } }, e.setTransitioning = function (t) { this._isTransitioning = t; }, e.dispose = function () { o.default.removeData(this._element, 'bs.collapse'), this._config = null, this._parent = null, this._element = null, this._triggerArray = null, this._isTransitioning = null; }, e._getConfig = function (t) { return (t = { ...S, ...t }).toggle = Boolean(t.toggle), d.typeCheckConfig(T, t, N), t; }, e._getDimension = function () { return o.default(this._element).hasClass('width') ? 'width' : 'height'; }, e._getParent = function () { let e; const n = this; d.isElement(this._config.parent) ? (e = this._config.parent, typeof this._config.parent.jquery !== 'undefined' && (e = this._config.parent[0])) : e = document.querySelector(this._config.parent); const i = `[data-toggle="collapse"][data-parent="${this._config.parent}"]`; const a = [].slice.call(e.querySelectorAll(i)); return o.default(a).each(((e, i) => { n._addAriaAndCollapsedClass(t._getTargetFromElement(i), [i]); })), e; }, e._addAriaAndCollapsedClass = function (t, e) { const n = o.default(t).hasClass('show'); e.length && o.default(e).toggleClass('collapsed', !n).attr('aria-expanded', n); }, t._getTargetFromElement = function (t) { const e = d.getSelectorFromElement(t); return e ? document.querySelector(e) : null; }, t._jQueryInterface = function (e) { return this.each((function () { const n = o.default(this); let i = n.data('bs.collapse'); const a = { ...S, ...n.data(), ...(typeof e === 'object' && e ? e : {}) }; if (!i && a.toggle && typeof e === 'string' && /show|hide/.test(e) && (a.toggle = !1), i || (i = new t(this, a), n.data('bs.collapse', i)), typeof e === 'string') { if (typeof i[e] === 'undefined') throw new TypeError(`No method named "${e}"`); i[e](); } })); }, l(t, null, [{ key: 'VERSION', get() { return '4.6.0'; } }, { key: 'Default', get() { return S; } }]), t; }()); o.default(document).on('click.bs.collapse.data-api', '[data-toggle="collapse"]', (function (t) { t.currentTarget.tagName === 'A' && t.preventDefault(); const e = o.default(this); const n = d.getSelectorFromElement(this); const i = [].slice.call(document.querySelectorAll(n)); o.default(i).each((function () { const t = o.default(this); const n = t.data('bs.collapse') ? 'toggle' : e.data(); D._jQueryInterface.call(t, n); })); })), o.default.fn[T] = D._jQueryInterface, o.default.fn[T].Constructor = D, o.default.fn[T].noConflict = function () { return o.default.fn[T] = C, D._jQueryInterface; }; const k = 'dropdown'; const A = o.default.fn[k]; const I = new RegExp('38|40|27'); const j = {

...
(function ($) {
  let autoplay; let bgcolor; let blockleft; let blocknum; let blockshare; let blocktitle; let border; let core; let container; let content; let dest; let extraCss;
  let framewidth; let frameheight; let gallItems; let infinigall; let items; let keyNavigationDisabled; let margine; let numeratio;
  let overlayColor; let overlay; let title; let thisgall; let thenext; let theprev; let nextok; let prevok; let preloader; let $preloader; let navigation;
  let obj; let gallIndex; let startouch; let vbheader; let images; let startY; let startX; let endY; let endX; let diff; let diffX; let diffY; let threshold;
  let share; let sharelinks; let vbfooter; let
    sharepos;
  ...
  $.fn.extend({
    ...
    venobox(options) {
      ...
      const defaults = {
        ...
        cb_pre_open() { return true; }, // Callbacks - thanx @garyee
        cb_post_open() {},
        cb_pre_close() { return true; },
        cb_post_close() {},
        cb_post_resize() {},
        cb_after_nav() {},
        cb_content_loaded() {},
      ...
      return this.each(function () {
        ...
        $('body').on('click touchstart', closeclickclass, (e) => {
        ...
        const onTouchEvent = function (event) {
          let type;
          switch (event.type) {
        ...
        function updateoverlay() {
          ...
          $('img.vbox-figlio').on('dragstart', (event) => {
